# DSA Projeto 2 - Script 02 - Adicionar Nova Coluna ao Conjunto de Dados

# Imports
import os
from pyspark.sql import SparkSession
# A função lit serve para criar um valor literal constante.
from pyspark.sql.functions import lit
# Função de concatenação de Strings no PySpark
