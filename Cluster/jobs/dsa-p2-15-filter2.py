...
print("Estados que existem na lista de estados:")
...
print("Estados que não existem na lista de estados:")
# Filtra as linhas do DataFrame onde o valor da coluna 'estado' NÃO está na lista 'lista_estados_dsa'
df.filter(~df.estado.isin(lista_estados_dsa)).show(truncate=False)

print("Filtra os estados SP com o gênero Masculino:")
...
print("Outros Filtros com Sintax SQL:\n")

print("Filtra linhas onde o campo 'nome' começa com 'L'")
# Filtra linhas onde o campo 'nome' começa com "L"
df2.filter(df2.nome.like("L%")).show(truncate=False)

print("Filtra linhas onde o campo 'nome' contém a substring 'carvalho' em qualquer parte do texto")
...
print("Filtra linhas onde o campo 'nome' identifica nomes que terminam com 'carvalho'")
# Filtra linhas onde o campo 'nome' corresponde à expressão (?i).*carvalho$) regular que identifica nomes 
